    ...
    if("REBASE" STREQUAL "CHECKOUT")
      ...
      if(error_code)
        ...
        if(NOT "REBASE" STREQUAL "REBASE_CHECKOUT")
          ...
          message(FATAL_ERROR "\nFailed to rebase in: '/home/tonix/Documents/ATHENAS/C_CPP_Proyects/Math/build/_deps/gbench-src'."
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/home/tonix/Documents/ATHENAS/C_CPP_Proyects/Math/build/_deps/gbench-src'."
                              "\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
